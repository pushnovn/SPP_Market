                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <s:iterator value="orderReports" var="orderReport">
                                    <tr>
                                        ...
                                        <td>
                                            <s:iterator value="getItemsList()" var="itemReport">
                                                <s:property value="count"></s:property> x <s:property value="item.name"></s:property> by <s:property value="item.getSupplier().getCompanyName()"></s:property> &nbsp;
                                            </s:iterator>
                                        </td>
