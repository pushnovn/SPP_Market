<div class="modal items_add_modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">.
            <form method="post" action="supplier-dashboard-items-add.action">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="items_add_count_in_market" type="number" required class="form-control" name="item.countInMarket">
                    </div>
                    <div class="form-group">
                        <label>Price: </label>
